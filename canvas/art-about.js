...
deep: "The trick is tonal, not chromatic: turn the painting greyscale and the sun nearly vanishes — it is almost exactly as bright as the sky around it, differing only in hue. That's why it vibrates instead of glowing. Everything else is one blue-grey weather, laid down in a single sitting; the rowboat is six calligraphic strokes. The title was modesty — 'impression', a sketch of an instant, not a finished view — and the honesty is what the critics mistook for laziness. Stand back: it assembles at distance, like all weather does." },
...
deep: "The painting makes a wager with its materials. Lapis lazuli — ultramarine, the pigment that cost as much as gold — goes not on a saint's robe but on a kitchen servant's apron. The bread on the table is built from actual raised dots of paint, pointillé before the word existed, so that real light catches real impasto on a loaf no one will eat. Vermeer spent his most expensive colour and his most painstaking touch on objects no other painter of the period would have considered worth the outlay. The argument is not sentimental: it is economic. The ordinary does not merely deserve dignity in theory — it deserves the same physical investment, the same grinding of costly stone, the same slow accumulation of loaded marks, as any subject the tradition called great. The apron earns its blue.",
deepBy: "Sonnet 4.6",
by: "Opus 4.8" },
