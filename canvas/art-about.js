...
"the-gates-of-hell": {
about: "Rodin's bronze portal of Dante's damned, begun in 1880 as doors for a museum that was never built — he reworked it for thirty-seven years and died with it unfinished, and every cast was assembled from those plasters afterward.",
deep: "Everything on this gate is falling, has fallen, or is about to. The Three Shades at the peak are one man cast three times and rotated, heads hanging almost horizontal, arms dropping — Dante's 'abandon all hope' rewritten as a gesture that points down into the plunge. In the tympanum below, one small seated figure holds the only stillness on the surface — The Thinker, before he was enlarged; The Kiss and Ugolino began here too. The undercutting is deep enough that limbs pull free of the ground and shadow pools behind them. Look at the jambs, where a classical portal carries fluting: Rodin stacked individual bodies, the frame that should contain Hell made of the damned.",
deepBy: "Sonnet 4.6",
by: "Opus 4.8" },
...
"skarga-s-sermon": {
about: "The Jesuit preacher Piotr Skarga flings his arms up at the margin, telling a king and senate who will not look at him that Poland will fall — painted in 1864, as a Polish uprising was being crushed.",
deep: "No invaders appear in this room. Only Poles — some forty of them, fur-trimmed and umber, arms folded, heads dropped, one whispered aside, almost nobody meeting the preacher's eye. Skarga is the single vertical that stands clear of the mass, a black column against pale stone, placed off to the side where a truth-teller can be ignored. Diagonally opposite, a cardinal pools scarlet across the floor with half his back to us, gorgeous and inert. The gilded coats of arms behind them are the realm's own emblems, dulled and half-swallowed by dark. A woman clasps her hands near her face; she and a monk with a cross are the only proof the words landed.",
deepBy: "Sonnet 4.6",
by: "Opus 4.8" },
...
about: "Kraków, 1521: a colossal bronze bell cast from captured cannon is hauled up the Wawel cathedral tower. Matejko painted the hoist in 1874, and posed most of his own family as the Renaissance court.",
deep: "The bell is still in that tower, and still rings — an object that outlasted the state that cast it, which is the whole reason for a picture made in 1874 under Austrian rule. Matejko built his name on defeats and deathbeds; here Poland lifts something instead of losing it. Two-thirds of the canvas are jammed with court, heads stacked into heads with no air between them, and the king sits lower than the courtiers ringing him — watching, not commanding. Then the right third empties to bare sky, and the bronze gets its tonnage from the vacancy. Across the seam runs one taut rope: the court at one end, bent backs hauling at the other.",
deepBy: "Sonnet 4.6",
by: "Opus 4.8" },
...
"berthe-morisot": {
about: "The painter Berthe Morisot, 1873 — Manet's most-painted sitter, here with no fan, no flowers, just a pale face lifted out of a field of black, a year before she married his brother.",
deep: "The face is finished; the rest is abandoned. Warm light on the forehead, grey-green shadow banking down the far side of the nose, the mouth closed and faintly down — then below the throat, one field of black in which the dress is barely separable from the wall behind it, and a bib of lace that is a few dragged whites and a scrape. Look at how the blacks shift, brown-warm in one passage, cool in the next, carrying flecks of the reddish ground so the darkness never goes dead. Morisot was a major painter herself, and about to marry into the family. No props, no performance — she would have seen through it.",
by: "Opus 4.8" },
...
about: "Two women sharing one minute in a cool Dutch room, about 1670: one bent over a letter, entirely inside it; the other standing behind with folded arms, chin up, waiting out a task that is not hers.",
deep: "Stolen twice in twelve years — an IRA gang in 1974, Martin Cahill's crew in 1986 — recovered both times, a violent history for so unhurried a room. At the bottom edge, under the carpet's overhang, lie a crumpled sheet and a stick of red sealing wax: a first attempt thrown away, making the letter underway a second try and the words expensive. Vermeer spends his finish to match — the bent head modelled and carrying the single note of lemon yellow, the maid's face left barely described, a silhouette that never competes for your eye. Above them the finding of Moses hangs loose and in shadow: an infant lifted from the water, providence kept to a thought.",
deepBy: "Sonnet 4.6",
by: "Fable 5" },
...
about: "A music lesson that is also a courtship, about 1659 — the man leaning in to share her page stays fixed on it, but she has looked up and out, straight at whoever just walked in. That is you.",
deep: "Every object in the room is an argument about love. Peer into the black frame on the back wall and a Cupid emerges holding up a single card — the period's emblem for constancy, one beloved and no other — hung directly over a man pressing his attentions on a girl. Below it a wine jug and glass catch the window light, a guard being loosened. A birdcage hangs against the leaded glass, captivity parked at the one source of light. A cittern lies unplayed in the near shadow, a duet not begun. Centuries of cleaning have thinned the canvas badly, and the man's face and the deep grounds read flat now. The turned face survives it.",
deepBy: "Sonnet 4.6",
by: "Fable 5" },
...
"the-milkmaid": {
about: "Vermeer gave a low-ranking kitchen servant the pyramidal mass and gravity of a devotional figure, treating the act of pouring milk as something worthy of the same attention as a religious subject. Painted c. 1660.",
deep: "Ultramarine cost more than gold, and rivals saved it for the Virgin's robes; Vermeer spent it on a kitchen servant's apron, giving her the frontal gravity of an altarpiece figure, no moral caption attached. Only the milk moves — everything else locked still, so a half-second of pouring is held open indefinitely. The bread is not painted rough, it is rough: beads of paint standing proud of the canvas, catching real light. Give the wall your longest look: bare plaster, two nails, a bluish patch, nearly half the canvas, graded by temperature alone, worked with the care other painters kept for a face. At the floor line, a tiny Cupid on one Delft tile — the one warm thought in a room otherwise all work: she is young, and somewhere else in her head.",
deepBy: "Sonnet 4.6",
by: "Opus 4.8" },
...
about: "The Palace of Westminster in 1904, dissolved to a blue-violet rumour between a sun burning through the fog above it and the same fire spread across the Thames below — one break of light made the entire subject.",
deep: "The fog here had lifted long before the picture was finished. Monet worked dozens of canvases from a terrace above the Thames, swapping them as the light moved, then resolved them at Giverny from memory — one glimpse averaged from many mornings. Look at the palace for a window, a cornice, a course of stone: there is none, and the mist drags straight across it, so London's most legible landmark reads thinner than the air. The sun has no clean disc either — a frayed knot of orange eating into the haze — and it returns at the bottom as coral and mauve stippled over cold water. Nothing is outlined; every boundary is a change of temperature.",
deepBy: "Sonnet 4.6",
by: "Fable 5" },
...
about: "A bather in a silvery wood, 1873 — nothing marks her as Diana: no bow, no hound, no crescent. Corot painted fewer than thirty nudes in a long career, and this one comes two years before his death.",
deep: "The wood has almost no leaves — dragged, flicked strokes of greyed green over a lighter ground, mass without botany. Everything is held to one silvery key so a single reserved passage can burn: the standing body, warm ivory, lit almost without cast shadow, so she seems to hold light rather than receive it. Nowhere is she cut out with a line — the edges dissolve, which fuses her to the glade instead of pasting her on it. A second nude sits among the roots at the right, dimmed nearly to the value of the earth — easy to miss, and the whole of the picture's claim to myth. Corot called these souvenirs: remembered woods, not visited ones.",
deepBy: "Sonnet 4.6",
by: "Fable 5" },
...
about: "A wreck and its fishing boats, about 1840-45 — dissolved so far into churned surf and spray that the disaster is nearly impossible to find. Nobody knows what Turner called it; the title and the date were both assigned later.",
deep: "The late pictures he did exhibit already struck critics as \"tinted steam\"; this one he never showed anyone. The whole canvas sits in a narrow band of pale warm greys, which is why one small bluish hull and a few leaning masts, off-centre and half-swallowed, carry the whole human stake of the scene. Look for the horizon: there is none, and sky and spray are the same thin films of paint, the ground glowing through. The rusty-ochre streaks dragged across the swell are not describing waves; they are the water's speed. At the lower right the paint thickens into a surge that climbs toward you and throws the eye back into the rotation, so the storm never settles.",
deepBy: "Sonnet 4.6",
by: "Fable 5" },
...
about: "A pale head floating in a burst of yellow, 1910 — no ground, no horizon, nothing to hold it up. Redon spent half his career working only in black, then past sixty entered colour \"as if into paradise\".",
deep: "The mystery is built, not found. Redon scratched and scumbled a dense dark ground, textured like a weathered wall, then coaxed light out in blooms — the reverse of the usual order, which is why the panel glows from inside. The yellow goes on in short strokes fanning outward, making a halo without ever drawing one. The head is left edgeless, no telling where form ends and glow begins; a contour would have made it a thing rather than an arrival. The hot red ribbons at lower left could be a horse's mane or shadow catching fire; he lets them stay both. A fantasia follows feeling instead of rule, and this one never settles.",
deepBy: "Sonnet 4.6",
by: "Fable 5" },
...
about: "John the Baptist, around 1514 — a soft, androgynous body surfacing out of total darkness, one finger raised toward a heaven Leonardo declined to paint. He carried the panel to France and kept it beside him until he died.",
deep: "A desert prophet should be gaunt and shouting; this one is soft, warm, faintly amused. The mouth is the Mona Lisa's — corners lost in sfumato so the expression never settles, and viewers have found the saint too knowing, too sensual, ever since. Look for the reed cross that identifies him: a thin diagonal behind the raised arm, pitched nearly the value of the ground, all but swallowed, and the fur skin with it. There is no drawn contour anywhere: the shoulder, built in translucent glazes, appears to breathe, and at the outer edge the curls stop being describable and merge with the black they came out of.",
deepBy: "Sonnet 4.6",
by: "Opus · Fable" },
...
about: "The girl who will one day steady Paris against Attila, painted in 1892 as a shepherdess at the instant of listening — the vision withheld: no angel, no ray, only a halo bleeding into blue dusk.",
deep: "The halo is the only event: not a drawn gold disc but a bloom of pale light that flares at the hair and bleeds outward until you cannot say where holiness stops and weather begins. Osbert starves the palette to blues and greys with a faint green in the grass, the whole canvas tuned to one temperature. Two pale notes answer the halo: the blouse and the hands, folded low and loosely, not clasped in fervour but simply stilled, a body held quiet to hear. Even the lamb is brushed in her tones rather than the ground's. Puvis de Chavannes, whose flat muralist hush this is built on, praised it; so did Rodin.",
deepBy: "Sonnet 4.6",
by: "Opus · Fable" },
...
about: "Kyoto's Golden Pavilion burning, 2 July 1950, set alight by a young acolyte — the crime Mishima would novelise. Ryūshi never saw it: he read the newspaper and had this painted and shown within two months.",
deep: "Rain falls straight through the blaze and nothing goes out: white lines ruled diagonally over flame and forest alike, the weather that should be mercy merely present. Three materials, and no more: ink, vermilion, gold. The left third is pines in ink alone, no warm touch, so the vermilion opposite reads as the only heat in a soaked world. The flame is drawn rather than massed, each tongue a separate curling stroke, timber railings still legible inside the heat. Gold is flung through the smoke at the top — the pavilion's gilding, leaving. Above, the phoenix finial stands clear in dark line, the creature that returns from ash, presiding over a fire that leaves only that.",
deepBy: "Sonnet 4.6",
by: "Opus · Fable" },
...
about: "Maria Sampere in furs, 1911 — the painter's wife, and his sitter for the next thirty years. Below the collar the picture dissolves into a near-black column; everything Pausas has is spent on one side-lit smile.",
deep: "A reviewer praised the \"life and action of the figure,\" which is a strange thing to say about a body that has been dissolved. Below the collar there are no folds, no arms, no seams — only the wet drag of the brush over a near-black mass, warm shifting to cool where bulk needs suggesting. Two touches keep it from going abstract: a feather leaning off the hat into the empty upper field, and at the hem a small hard gleam of shoe-tip, a foot bearing weight. Between them the tall dark middle is left to breathe. All the finish in the canvas is in one cheek, lit low, and a smile that slides past you.",
deepBy: "Sonnet 4.6",
by: "Opus · Fable" },
...
deep: "The raised arm is a woman at her toilette, gathering her hair above the shoulder — the motion of preparing to be seen, staged in flowers that mean the opposite. The elbow opens her body fully to view, which the gesture pretends not to intend. Watch the touch change with substance: flesh stippled so tight it holds light with no drawn edge, hair in coarse near-black flecks that keep their weight, the lilies nervous dabs that swarm and never resolve into single blooms, closer to foam than to flowers. Martin draws no contour anywhere, so she seems to condense out of the haze and the face stays smudged, undecided — a sharper mouth would have settled it.",
deepBy: "Sonnet 4.6",
by: "Opus · Fable" },
