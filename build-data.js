...
//   albums = [title, artistIdx, plays, firstYear, lastYear, yearTail]
...
const mediaAlbums = _albumEntries.map(([key, plays], i) => {
  ...
  return [title, _ai(artist), plays, sp ? sp[0] : 0, sp ? sp[1] : 0, _tail(albumYear.get(key))];
});
...
// albums = [title, artistIdx, plays, firstYear, lastYear, yearTail]; tracks = [title, artistIdx, plays, albumIdx, yearTail].
