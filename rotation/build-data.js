...
// batches). Only tracks WITH a blurb ship; value = [excerpt, geniusId] for the attribution link.
const GENIUS_ABOUT = _readJson("genius-about.json"); // key → [excerpt|null, fullLen, id]
const _aboutShip = {};
for (const [k, v] of Object.entries(GENIUS_ABOUT)) if (v && v[0]) _aboutShip[k] = [v[0], v[2] || 0];
