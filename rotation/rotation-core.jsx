...
/* Insight-card figures keep the serif face and drop a size instead (Fuad 2026-08-20). Swapping them
   ...
   heaviness was never the family — it was 27px of accent pink next to a 12px name and a 9px
...
/* the calibrated/cathartic provenance chip — quiet meta, no accent (Fuad 2026-08-27: the
   warm dark-orange differentiated it too much); both chips inherit this one rule */
.tv-mood-src { display: inline-block; margin-left: 8px; padding: 1px 7px; border-radius: 999px;
  ...
  color: var(--ink-faint); border: 1px solid var(--rule); background: transparent; cursor: help; }
